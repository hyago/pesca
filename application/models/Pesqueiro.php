...
private $dbTablePesqueiros;
    ...
    {
        $this->dbTablePesqueiros = new Application_Model_DbTable_Pesqueiros();
    ...
    public function insert(array $request)
    {
        ...
        $dadosPesqueiros = array(
            'paf_pesqueiro' => $request['nomePesqueiro']
        );
    ...
    public function update(array $request)
    {
        ...
        $wherePesqueiros= $this->dbTablePesqueiros->getAdapter()
                ->quoteInto('"paf_id" = ?', $request['idPesqueiro']);
        
        $this->dbTablePesqueiros->update($dadosPesqueiros, $wherePesqueiros);
    }
    
    public function delete($idPesqueiros)
    {
        $this->dbTablePesqueiros = new Application_Model_DbTable_Pesqueiros();       
                
        $wherePesqueiros= $this->dbTablePesqueiros->getAdapter()
                ->quoteInto('"paf_id" = ?', $idPesqueiros);
